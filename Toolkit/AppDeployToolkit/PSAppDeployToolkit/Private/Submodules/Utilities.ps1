...
function ConvertTo-NTAccountOrSID
{
    ...
    .EXAMPLE
    # Convert a Windows NT Account name to the corresponding SID
    ConvertTo-NTAccountOrSID -AccountName 'CONTOSO\User1'

    .EXAMPLE
    # Convert a Windows NT Account SID to the corresponding NT Account Name
...
function Get-RunningProcesses
{
    ...
    .OUTPUTS
    System.Boolean. Rettuns $true if the process is running, otherwise $false.
