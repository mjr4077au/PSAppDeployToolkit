...
function Get-HardwarePlatform
{
    ...
    .OUTPUTS
    System.String. Returns the hardware platform (physical or virtual)
...
function Get-WindowTitle
{
    ...
    .EXAMPLE
    # Get details for each window that has the words "Microsoft Word" in the title.
    Get-WindowTitle -WindowTitle 'Microsoft Word'

    .EXAMPLE
    # Get details for all windows with a title.
...
function Test-Battery
{
    ...
    .OUTPUTS
    System.Collections.Hashtable. Returns a hashtable containing the following properties
    - IsLaptop
    - IsUsingACPower
    - ACPowerLineStatus
    - BatteryChargeStatus
...
function Get-PendingReboot
{
    ...
    .EXAMPLE
    # Return boolean value determining whether or not there is a pending reboot operation.
